        ...
        <div class="card bordered"
            ...
            <div class="card-body  text-center">
                ...
                <h5 class="card-title text-linear border-bottom border-2 border-info-subtle py-3 text-start mt-5">
                    Karachi, Pakistan</h5>
                <p class="card-text fs-1 text-secondary">22<sup>0</sup> <i class="fa-solid fa-temperature-high text-warning"></i></p>
                <p class="card-text text-secondary"><i class="fa-regular fa-calendar-days text-warning"></i> July 21 <sup>st</sup></p>
            </div>
        </div>
    </div>`);
  ...
  document.writeln(`<div class="container-xxl d-flex justify-content-center align-items-center card-wrap bg-rainy">
        <div class="card bordered"
            ...
            <div class="card-body  text-center">
                ...
                <h5 class="card-title text-linear border-bottom border-2 border-info-subtle py-3 text-start mt-5">
                    Queeta, Pakistan</h5>
                <p class="card-text fs-1 text-secondary">-2<sup>0</sup>  <i class="fa-solid fa-temperature-high text-info"></i></p>
                <p class="card-text text-secondary"><i class="fa-regular fa-calendar-days text-warning"></i> July 21 <sup>st</sup></p>
            </div>
        </div>
    </div>`);
  ...
  document.writeln(`<div class="container-xxl d-flex justify-content-center align-items-center card-wrap bg-windy">
        <div class="card bordered"
            ...
            <div class="card-body  text-center">
                ...
                <p class="card-text fs-1 text-secondary">61<sup>0</sup>  <i class="fa-solid fa-temperature-high text-info"></i></p>
                <p class="card-text text-secondary"><i class="fa-regular fa-calendar-days text-warning"></i> July 21 <sup>st</sup></p>
            </div>
        </div>
    </div>`);
  ...
  document.writeln(`<div class="container-xxl d-flex justify-content-center align-items-center card-wrap bg-foggy">
        <div class="card bordered"
            ...
            <div class="card-body  text-center">
                ...
                <h5 class="card-title text-linear border-bottom border-2 border-info-subtle py-3 text-start mt-5">
                    Lahore, Pakistan</h5>
                <p class="card-text fs-1 text-secondary">-2<sup>0</sup>  <i class="fa-solid fa-temperature-high text-light"></i></p>
                <p class="card-text text-secondary"><i class="fa-regular fa-calendar-days text-warning"></i> July 21 <sup>st</sup></p>
            </div>
        </div>
    </div>`);
  ...
  document.writeln(`<div class="container-xxl d-flex justify-content-center align-items-center card-wrap bg-cloudy">
        <div class="card bordered"
            ...
            <div class="card-body  text-center">
                ...
                <h5 class="card-title text-linear border-bottom border-2 border-info-subtle py-3 text-start mt-5">
                    Karachi, Pakistan</h5>
                <p class="card-text fs-1 text-secondary">-2<sup>0</sup>  <i class="fa-solid fa-temperature-high text-primary"></i></p>
                <p class="card-text text-secondary"><i class="fa-regular fa-calendar-days text-warning"></i> July 21 <sup>st</sup></p>
            </div>
        </div>
    </div>`);
  ...
  document.writeln(`<div class="container-xxl d-flex justify-content-center align-items-center card-wrap bg-stormy">
        <div class="card bordered"
            ...
            <div class="card-body  text-center">
                ...
                <p class="card-text fs-1 text-secondary">-2<sup>0</sup>  <i class="fa-solid fa-temperature-high text-success"></i></p>
                <p class="card-text text-secondary"><i class="fa-regular fa-calendar-days text-warning"></i> July 21 <sup>st</sup></p>
            </div>
        </div>
    </div>`);
